...
//   const fileDoc = await cozy.client.files.statByPath(CTXT.fields.path + filename)
//   if (fileDoc) throw new Error('fileAlreadyHere')
//   // get dirID and save
//   const dirDoc  = await cozy.client.files.statByPath(CTXT.fields.path) // todo : est on sûr que dirDoc existe ?
//   const fileDoc = await cozyClient.files.create(article.inlinedHtml, {
//     name        : filename    ,
//     dirID       : dirDoc._id  ,  // TODO CTXT.fields.path   cozy.client.files.statByPath(path) ._id
